...
<u>Тема лекции</u> Написание кода на Python Версии языка Python Ввод и вывод текстовых данных Операции + и * со строками Интроспекция в Python Память программы Объект строки и его методы Строка как итерируемый объект Срезы строк Текстовые файлы Вопросы, обсуждение, примеры
